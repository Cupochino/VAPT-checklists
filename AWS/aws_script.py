...
checks = [
    ...
    ("Security Groups", "aws ec2 describe-security-groups --query "SecurityGroups[*].{ID:GroupId,Name:GroupName,Inbound:IpPermissions}" --output table", "ec2_security_groups.json"),
